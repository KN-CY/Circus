...
public class Circus {
    ...
    public static void main(String[] args) {
        ...
        // Arrays.asList basically takes in an array and returns a list representation
        ...
        // comparator defined and overwritten in animal class
        animalArrayList.sort(Animal.AnimalNameComprator);
